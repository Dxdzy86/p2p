...
/**
 * 添加ZERO常量和与金融账户相关的小数位数常量
 * @author Dxd
 *
 */
public class BidConst {
	public static final int STORE_SCALE = 4;//数据库中保存4位小数
	public static final int DISP_SCALE = 2;//显示给前台保留2位小数
	public static final int CAL_SCALE = 8;//数据计算过程保留8位小数
	public static final BigDecimal ZERO = new BigDecimal("0.0000");
	public static final String DEFAULT_ADMIN = "admin";//默认超级管理员的账户名
