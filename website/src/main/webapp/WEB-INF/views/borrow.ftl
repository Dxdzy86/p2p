			...
			<div class="el-borrow-item col-sm-4">
				...
				<div class="el-borrow-item-content">
					...
					<ul>
						...
						<li>
							<#if (userInfo.creditBorrowScore &lt; creditBorrowScore)>
					...
					<#if userInfo.hasSaveBasicInfo && userInfo.hasIdentityAuth && (userInfo.creditBorrowScore >= creditBorrowScore) && userInfo.hasVedioAuth>
